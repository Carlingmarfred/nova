...
| N06 | Field stdlib pack: cli args/env/exit, csv, datetime parse+format, regex | P1 | L | N04 | ✅ 2026-08-24 (cli args/env/exit · csv RFC4180 subset · datetime ISO-UTC slim · regex matches/find/replace; 9 integration tests) |
| N07 | `nova test` runner (= D01) targeting the native CLI | P1 | M | N05 | ✅ 2026-08-24 (recursive *.test.nova discovery, fresh VM per file, test.equal/true/fail, summary+exit codes; 4 integration tests) |
| N08a | History/undo engine: design-freeze doc + v0 cut in native runtime | P1 | L | N05 | ✅ 2026-08-24 (specs/history_engine.md freeze + history.snapshots/count queries) |
| N08b | Flow<T>: design-freeze doc + v0 cut (lists first; streams/channels stubbed) | P1 | L | N08a | ✅ 2026-08-24 (specs/flow.md freeze + take/skip/concat/flatten/unique/chunk) |
| N09 | LSP v1: diagnostics, hover, completion (= F01 early) | P1 | XL | N02 | ⏭ deferred to v0.21 by owner decision 2026-08-24 (v0.20.0 ships without LSP) |
...
| Date | Change |
|---|---|
| 2026-08-24 | **Phase 0.2 code-complete**: N06 field pack (cli/csv/datetime/regex), N07 `nova test` runner, N08a/b freeze docs + native cuts all landed with integration tests. N09 LSP deferred to v0.21 (owner). ROADMAP rewritten to mirror Phase 0.2. Validation: cargo test/clippy clean across 8 suites, oracle 236/236, diff harness 29/29.
